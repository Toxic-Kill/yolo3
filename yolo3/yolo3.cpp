...
//参数设置
#define YOLOV3_VIDEO		"D:\\Files\\DIP\\本来是一场很严肃的车祸，看完监控，你们忍住“别笑”.166491947.flv"		
#define OPENPOSE_VIDEO		"D:\\Files\\DIP\\鲇.mp4"	
...
int yoloV3()
{
	...
	//coco数据集的名称文件，80类
	string classesFile = "D:\\Files\\DIP\\coco.names";
	//yolov3网络模型文件
	String yolov3_model = "D:\\Files\\DIP\\yolov3.cfg";
	//权重
	String weights = "D:\\Files\\DIP\\yolov3.weights";
...
int openpose()
{
	...
	//读入网络模型和权重文件
	String modelTxt = "D:\\Files\\DIP\\openpose_pose_coco.prototxt";
	String modelBin = "D:\\Files\\DIP\\openpose_caffe_models\\caffe_models\\pose\\coco\\pose_iter_440000.caffemodel";
	...
	while (1) {
		...
		//创建输入
		Mat inputBlob = cv::dnn::blobFromImage(frame, 1.0 / 255, Size(W_in, H_in), Scalar(0, 0, 0), false, false);
